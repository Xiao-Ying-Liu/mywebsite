...
This article shows you how to cite papers with three or more authors using *et al.* style. The example is for jpe bib style, but the method should apply to other citation style as well.
